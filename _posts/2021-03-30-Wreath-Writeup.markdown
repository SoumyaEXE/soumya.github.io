...
0 c39 c71">   </span><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 333.50px; height: 344.19px;">![](/images/0xd4y-logo-gray.png)</span>
...
![](/_reports/Wreath/image61.png)</span>
