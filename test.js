! function() {
    ...
    var n = {
            load: function(e, t) {
                ...
                n.open("GET", e, !0), n.onreadystatechange = function(e, t) {
                    return function() {
        ...
        o = new function() {
            this.matches = function(e, t) {
                return "string" == typeof e && (e = e.trim()).toLowerCase().indexOf(t.toLowerCase()) >= 0
            }
        },
        u = {
            put: function(n) {
                return e(n) ? t(n) : function(e) {
                    return Boolean(e) && "[object Array]" === Object.prototype.toString.call(e)
                }(n) ? function(n) {
                    for (var r = [], i = 0, o = n.length; i < o; i++) e(n[i]) && r.push(t(n[i]));
                    return r
                }(n) : undefined
            },
            clear: function() {
                        ...
                        var u = function(e, t, n, r) {
                            for (var i in e)
                                if (! function(e, t) {
                                        ...
                                        return n
                                    }(e[i], r.exclude) && n.matches(e[i], t)) return e
                        }(e[o], t, n, r);
                        u && i.push(u)
                    }
                    return i
            ...
            setOptions: function(e) {
                (l = e || {}).fuzzy = e.fuzzy || !1, l.limit = e.limit || 10, l.searchStrategy = e.fuzzy ? i : o
            }
        },
        a = [],
        l = {};
    ...
    var c = {
            ...
            setOptions: function(e) {
                f.pattern = e.pattern || f.pattern, f.template = e.template || f.template, "function" == typeof e.middleware && (f.middleware = e.middleware)
            }
        },
        f = {};
    ...
    ! function(e) {
        function t(e) {
            u.put(e), a.searchInput.addEventListener("keyup", function(e) {
                (function(e) {
                    return -1 === [13, 16, 20, 37, 38, 39, 40, 91].indexOf(e)
                })(e.which) && (a.resultsContainer.innerHTML = "", i(e.target.value))
            })
        }
        ...
        var a = {
            ...
            f = function p(e) {
                if (! function(e) {
                        return !!e && "undefined" != typeof e.required && e.required instanceof Array
        ...
        e.SimpleJekyllSearch = function(e) {
            return f.validate(e).length > 0 && o("You must specify the following required options: " + l), a = s.merge(a, e), c.setOptions({
                template: a.searchResultTemplate,
                middleware: a.templateMiddleware
            }), u.setOptions({
                fuzzy: a.fuzzy,
                limit: a.limit
            }), s.isJSON(a.json) ? t(a.json) : function(e) {
